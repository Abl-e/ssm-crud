    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="emp_save">保存员工信息</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $("#emp_save").click(function () {
        ...
        if(regName.test($("#empName_add_input").val())){
            checkForm("#empName_add_input","success","用户名必须为6-16数字字母或者2-6中文汉字");
        }else{
            checkForm("#empName_add_input","error","用户名不可用");
            return;
        }
        //校验邮箱地址
